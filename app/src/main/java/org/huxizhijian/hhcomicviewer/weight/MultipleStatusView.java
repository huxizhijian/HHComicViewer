...
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId = a.getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.status_empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.status_error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.status_loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.MultipleStatusView_noNetworkView, R.layout.status_no_network_view);
    ...
    public final void showError(@IdRes int errorTextId, String errorMessage) {
        showError();
        TextView textView = mErrorView.findViewById(errorTextId);
