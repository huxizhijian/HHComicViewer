...
import org.huxizhijian.hhcomic.model.comic.service.bean.Filter;
 ...
 * @date 2018/10/8
 */
@SourceImpl(id = Dmzj.SOURCE_KEY, name = Dmzj.SOURCE_NAME)
public class Dmzj extends Source {
    ...
    protected void initCategoryList(Category.ListBuilder listBuilder) throws IOException {
        ...
        for (int i = 0; i < arraySize; i++) {
            ...
            if (i == 0) {
                // 第一个subtitle，记录下来
                categorySubtitle = jsonObject.getString("title");
            }
