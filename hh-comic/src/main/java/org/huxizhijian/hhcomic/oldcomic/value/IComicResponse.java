...
package org.huxizhijian.hhcomic.oldcomic.value;
...
public interface IComicResponse {
    ...
    /**
     * 获取结果，通常为{@link org.huxizhijian.hhcomic.oldcomic.bean.Comic}或者它的List集合
     *
     ...
     * 添加返回结果
     *
     * @param key   {@link org.huxizhijian.hhcomic.oldcomic.type.ResponseFieldType}标识的key
     * @param field 结果类
     * @return 链式调用
     */
