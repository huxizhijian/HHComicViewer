 ...
 * @date 2018/10/1
 */
public abstract class ComicSource extends Source {
     ...
     */
    public ComicSource() throws IOException {
        mOkHttpClient = HHGolbalVariable.getConfiguration(ConfigKeys.OKHTTP_CLIENT);
        init();
